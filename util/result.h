#ifndef OPENGL_3D_ENGINE_RESULT_H
#define OPENGL_3D_ENGINE_RESULT_H
...
bool operator==(const Result<T, E>& lhs, const Result<T, E>& rhs) {
    static_assert(conc::EqualityComparable<T>::value, "T must be EqualityComparable for Result to be comparable");
    static_assert(conc::EqualityComparable<E>::value, "E must be EqualityComparable for Result to be comparable");
...
#endif //OPENGL_3D_ENGINE_RESULT_H
